...
function displayImages(images) {
    ...
    const lightbox = new (0, _simplelightboxDefault.default)(".photo-link", {
        sourceAttr: "href"
    });
}
...
async function handleSearchFormSubmit(event) {
    ...
    if (data) {
        displayImages(data);
        if (data.hits.length === perPage) loadMoreBtn.style.display = "block";
        else {
...
function showMessage(totalHits) {
    (0, _notiflixDefault.default).Notify.warning(`Hooray! We found ${totalHits} images.`);
}
...
},{}],"kaxSc":[function() {},{}]},["4rkIz","8lqZg"], "8lqZg", "parcelRequired7c6")
